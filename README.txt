...
-
This project will build a Movie Trailer Website where users can see list movies and watch the trailers.
...
This Movie Trailer Website Project#1 consists of 3 files of written in Python version 2.7.9.
these files stores a list of movies titles, 
along with their respective box art imagery and movie trailer website. 


The Movie Class in the media.py module creates a structure to store list of movies that includes movie title, 
...
The docs may also be run locally.
 ...
 STEPS TO 
RUN PROGRAM LOCALLY ON YOUR DESKTOP-----

1.Install python 2.7.9 if it is on installed on your desktop.
2.From the root /Movie-Trailer-Website directory, run entertainment_center.py in the command line/IDLE(SHELL).
3.The program will open a browser windows and will display the movie posters ready to be clicked for a movie trailer.
